 ...
 */
export const TEST_100MB_MAGNET =
  `magnet:?xt=urn:btih:67d01ece1b99c49c257baada0f760b770a7530b9&dn=testdata_100mb.bin&${buildPeerHints()}`

/**
 * 1GB test file - generated by seed_for_test.py with seed 0xDEADBEEF.
 */
export const TEST_1GB_MAGNET =
  `magnet:?xt=urn:btih:18a7aacab6d2bc518e336921ccd4b6cc32a9624b&dn=testdata_1gb.bin&${buildPeerHints()}`
